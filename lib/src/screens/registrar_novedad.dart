...
class NovedadPage extends StatefulWidget {
  ...
  final Cuenta cuenta;
  NovedadPage(this.serverController, this.cuenta, {Key? key}) : super(key: key);
...
class _NovedadPageState extends State<NovedadPage> {
  ...
  Widget build(BuildContext context) {
    ...
    widget.cuenta.lectura_actual = "0.0";
                      ...
                      children: <Widget>[
                        ...
                        Switch(
                          ...
                          onChanged: (bool valueIn) {
                            ...
                            if(_switchCurrentValue==false){
                              Navigator.pushNamed(context,"/editar",arguments: widget.cuenta);
                            }
                          },
                        ),
                      ],
                        ...
                        onPressed: () async {
                          ...
                          if (_formKey.currentState!.validate()) {
                            ...
                            if (widget.cuenta.cuenta_id > 0 ) {
                              ...
                              //jbuestan
                              //DB.update_medicion(widget.cuenta);base64Encode
